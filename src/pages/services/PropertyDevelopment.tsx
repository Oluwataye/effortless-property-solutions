...
import heroImage from "/images/services/property-development-hero.png";
  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-20">
        <ServiceBreadcrumb serviceName="Property Development" />
        
        <ServiceHero
          title="Property Development"
          category="Development Services"
          description="End-to-end development solutions that transform your vision into reality with expertise, efficiency, and excellence."
